...
object Dependencies {
    object UI {
        ...
        const val extJUnit = "androidx.test.ext:junit:${Versions.appCompat}"
    ...
    object Lifecycle {
        const val = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.lifecycle}"
        const val = "androidx.lifecycle:lifecycle-runtime-ktx:${Versions.lifecycle}"
...
object Plugins {
    ...
    object Kotlin {
        ...
        const val jvn = "org.jetbrains.kotlin.jvn"
